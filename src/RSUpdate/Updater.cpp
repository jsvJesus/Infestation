...
void CUpdater::ProcessLoginResults()
{
        ...
        if(res == IDOK)
	{
      ...
      case CLoginHelper::ANS_Unknown:
        ...
        MessageBox(NULL, "Unknown account status, please contact support@email.com", "Login", MB_OK | MB_ICONEXCLAMATION);
        break;
...
void CUpdater::DoApplyNewKey(const char* key)
{
  ...
  switch(req.resultCode_)
  {
    ...
    case 2:
      MessageBox(NULL, "Your account type can not be updated, please contact support@email.com", "Update Account", MB_OK);
      break;
