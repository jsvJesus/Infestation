...
void game::Init(void)
{
  ...
  char title[512];
  sprintf(title, "Infestation Launcher %s (%s)", UPDATER_VERSION, UPDATER_BUILD);
...
static void drawProgressBar(CUpdater& updater)
{
  ...
  g_font3->PrintF( 9, base_y+15, r3dColor(170, 170, 170), "Infestation Launcher v%s%s", UPDATER_VERSION,UPDATER_VERSION_SUFFIX);
...
static void drawTimeExpiredButtons(CUpdater& updater)
{
  ...
  if(insideRect(g_rGetNewKeyBtn, g_mx, g_my)) 
  {
    ...
    if(g_mb) 
    {
      //ShellExecute(NULL, "open", "https://www.google.com/", "", NULL, SW_SHOW);
    }
  }
...
static void drawLoginButtons(CUpdater& updater)
{
  ...
  if(drawUrl(492, 445, "Forgot Password ?")) {
    // THAI ShellExecute(NULL, "open", "https://account.infestationmmo.com/account_check/", "", NULL, SW_SHOW);
    MessageBox(NULL, "Not implemented on server yet.", "Forgot Password ?", MB_OK);
  }
...
static void executeTopMenuButton(const CUpdater& updater, int btnIdx)
{
  ...
  switch(btnIdx)
  {
    ...
    case 3: // youtube
    {
      ShellExecute(NULL, "open", "https://www.youtube.com/", "", NULL, SW_SHOW);
      break;
    }
    
    case 4: // facebook
    {
      ShellExecute(NULL, "open", "https://www.facebook.com/", "", NULL, SW_SHOW);
      break;
    }
    
    case 5: // twitter
    {
      ShellExecute(NULL, "open", "https://www.twitter.com/", "", NULL, SW_SHOW);
      break;
    }
  }
